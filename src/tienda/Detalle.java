...
public class Detalle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtArticulo6.setText("Huevo en cubeta");
        getContentPane().add(txtArticulo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 150, -1));

        txtArticulo7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo7.setText("Fideos");
        getContentPane().add(txtArticulo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 150, -1));
        ...
        txtArticulo8.setText("Picadillo en lata");
        getContentPane().add(txtArticulo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 150, -1));
        ...
        txtArticulo5.setText("Harina de Trigo");
        ...
        getContentPane().add(txtTotalPagar, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 390, 110, -1));
    ...
    public void cantidades(String cantidad1, String cantidad2, String cantidad3, String cantidad4, String cantidad5, String cantidad6, String cantidad7, String cantidad8){
        ...
        txtPrecioSinIVA6.setText("39000");
        txtPrecioSinIVA7.setText("5500");
        txtPrecioSinIVA8.setText("3500");
        //precios + iva
        float p1 = 13000f + (13000f*0.10f);
        float p2 = 9000f + (9000f*0.10f);
        float p3 = 11500f + (11500f*0.10f);
        float p4 = 7000f + (7000f*0.10f);
        float p5 = 5000 + (5000f*0.10f);
        float p6 = 39000 + (39000f*0.10f);
        float p7 = 5500 + (5500f*0.10f);
        float p8 = 3500 + (3500f*0.10f);
        ...
        float aPagar7;
        float aPagar8;
        //descuentos para productos del 1 al 4
        if(cantidadp1>=3){          
            if(cantidadp1==3){ 
