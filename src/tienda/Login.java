...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtUsuario1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 340, 200, 40));
        ...
        getContentPane().add(etPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 380, 330, 40));

        etUsuario.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        etUsuario.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        getContentPane().add(etUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 310, 330, 40));
